...
import { Scale, Eye, EyeOff, Fingerprint, ChevronLeft, BarChart3, CalendarCheck, Vote } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex lg:flex-row">
      ...
      <div className="hidden lg:flex flex-1 gradient-navy flex-col justify-center px-16 xl:px-24 relative overflow-hidden">
        ...
        <div className="max-w-lg relative z-10">
          ...
          <h2 className="text-3xl font-black text-white leading-tight mb-4">Welcome back to your portal.</h2>
          <p className="text-white/60 text-lg mb-10 leading-relaxed">
            Access your attendance, vote in elections, manage dues, and download official documents.
          </p>
        ...
        <div className="flex-1 px-6 py-8 -mt-5 bg-background rounded-t-3xl lg:mt-0 lg:rounded-none lg:py-4">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-13 rounded-2xl bg-primary text-primary-foreground font-bold text-sm mt-2"
            >
